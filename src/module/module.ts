 ...
 * @returns CoreModule
 */
export function buildModule(module: Type<any>): CoreModule {
 ...
 * @returns CoreModule
 */
function coreModuleFromMetadata(data: HapinessModule, module: Type<any>, parent?: CoreModule): CoreModule {
 ...
 */
function metadataFromModule(module: Type<any>): HapinessModule {
 ...
 * @returns CoreModule
 */
function recursiveResolution(module: Type<any>, parent?: CoreModule): CoreModule {
    debug('Recursive resolution', module.name);
    const metadata = metadataFromModule(module);
    const coreModule = coreModuleFromMetadata(metadata, module, parent);
 ...
 */
export function findNestedModule(name: string, module: CoreModule): CoreModule {
